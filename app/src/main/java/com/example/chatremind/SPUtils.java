...
public class SPUtils {
    ...
    public static final String SP_NAME = "ubt_preference";

    private static SharedPreferences sharedPreferences;
    private static SPUtils prefsInstance;

    private static final String preferencesName = SP_NAME;
    private static final String LENGTH = "_length";

    public static final String DEFAULT_STRING_VALUE = "";
    public static final int DEFAULT_INT_VALUE = -1;
    public static final double DEFAULT_DOUBLE_VALUE = -1d;
    public static final float DEFAULT_FLOAT_VALUE = -1f;
     ...
     * @return Returns the stored value of 'what'
     */
    public static double getDouble(String what, double defaultDouble) {
        if (!contains(what))
     ...
     * @param what
     */
    public static void putDouble(String where, double what) {
     ...
     * @return Returns the stored value of 'what'
     */
    public static float getFloat(String what) {
